...
export const siteConfig = {
  ...
  title: 'Akhil Chava - Software Engineer',
  description: 'Software Engineer & Full Stack Developer specializing in React, Next.js, and Node.js',
  url: process.env.NEXT_PUBLIC_URL || 'http://localhost:3000',
  ogImage: '/meta/opengraph-image.png',
  author: {
    name: about.name,
    github: 'AVAHC4',
    linkedin: 'akhil-chava-96b314258',
    email: 'akhilchava4@gmail.com',
  },
  keywords: [
    'portfolio',
    'software engineer',
...
export const pageMetadata: Record<string, PageMeta> = {
  ...
  '/projects': {
    ...
    description:
      'Discover my projects and work across different technologies and domains. From web apps to AI/ML solutions.',
    keywords: [
      'projects',
      'portfolio',
      'web development',
